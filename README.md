...
## PRUEBA TÉCNICA DE PYTHON: EDA, LIMPIEZA DE DATOS, VISUALIZACIÓN CON MATPLOTLIB Y SEABORN, ESTADÍSTICA INFERENCIAL 

Prueba técnica  realizada por **Ana Pilar Dueñas Agudo** en el **Bootcamp de Análisis de Datos de Adalab (año 2025)**.
...
### DESARROLLO PRUEBA TÉCNICA. ETAPAS:
